<template>
  <section class="search" @submit.prevent="search">
    ...
    <section class="list" v-if="!noSearchShops">
      <ul class="list_container"> 
        <router-link :to="{
          path: '/shop',
          query: {id: item.id}
        }" class="list_li" tag='li' v-for="(item,index) of searchShops" :key="index"> 
          <section class="item_left"> 
            <img src= "./image/1.jpg"  class="restaurant_img"> 
          </section> 
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        keyword: '',
        // baseImgUrl: 'http://cangdu.org:4000/img/',
        noSearchShops: false
      }
    },
    computed: {
